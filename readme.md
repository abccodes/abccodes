...
- Relevant Courses:
    - Operating Systems. Relevant topics: Processes and threads, synchronization, CPU and memory management, file systems, device drivers, and real-time vs. multi-tasking systems
        - [Projects](https://github.com/abccodes/os-projects/tree/master):
            - File System
            - Device Driver
            - Buffered I/O Read
            - Multi-Threaded Data Processing
            - Shell with Pipes
    - Graduate Human Computer Interaction
...
- Relevant Courses:
    ...
    - Software Engineering. [Review Platform](https://github.com/abccodes/review_platform).
    - Analysis of Algorithms
        - Algorithm design and analysis, recursion, divide and conquer, backtracking, dynamic programming, greedy algorithms, and graph algorithms
    - Graduate Artificial Intelligence
        - Heuristic algorithms, machine learning, knowledge representation, and neural networks
...
- Relevant Courses:
    ...
    - Data Science for Image Analysis
        - Medical imaging, deep learning, CNNs, transfer learning, model evaluation, loss functions, performance metrics, and ML implementation on real data
...
- Relevant Courses:
    ...
    - Linear Algebra
        - Linear systems, matrix operations, vector spaces, eigenvalues/eigenvectors, orthogonality and orthogonalization
    - Probability and Statistics
        - Data analysis, probability distributions, confidence intervals.
    - Programming Methodology
        - C++ data structures and algorithms.
    - Machine Structures
        - Digital logic, data representation, assembly programming, CPU organization, memory systems, and handling interrupts.
    - Software Web Development
        - Client/server programming, user input processing, database integration, and web applications
    - Physics 2
        - Electricity and magnetism, covering electric and magnetic fields, circuits (DC and AC), electromagnetic induction, waves, and Maxwell’s equations

##### 2022
- My first software engineering internship at a Web3 social media startup called Huddln
- Worked as a Software Engineer freelancer. The main project I worked on was full-stack development of a decentralized investment (DAO) platform.
    - Relevant technology: Solidity, Firebase, React, and JavaScript.
- Relevant Courses:
